...
function [walking_merged, walking_parts_before_cut, walking_parts_after_cut, sample_times, sample_times_parts_before_cut, sample_times_parts_after_cut] = ...
    Kinects_merge_with_cut(walkings, inferred_vector, timestamps, end_times, new_A1, new_B1, new_C1, new_D1)
...
%if new_cp_flag == 1 ; 
	...
	[x_all, y_all, z_all, points_on_plane] = floor_project(CM_all, A, B, C, D) ;
